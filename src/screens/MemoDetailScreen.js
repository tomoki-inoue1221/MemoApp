  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <CircleButton onPress={() => { this.props.navigation.navigate('MemoEdit', { memo, returnMemo: this.returnMemo.bind(this) }); }} color="white" style={styles.editButton} name="pencil" />
      </View>
    );
  }
}
